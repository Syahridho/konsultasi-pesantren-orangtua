...
- ✅ Updated colors dari `bg-green-600` ke `bg-primary`
...
:root {
  ...
  /* green: oklch(0.506 0.168 243.83) - green-600 */
...
<Button className="bg-green-600">Click</Button>
...
- Add theme selector (emerald, green, purple)
