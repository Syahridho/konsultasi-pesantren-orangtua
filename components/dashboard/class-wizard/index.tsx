...
import ProgressIndicator, {
  WizardStep,
} from "@/components/admin/class-wizard/progress-indicator";
import SimpleClassDetailsStep from "./simple-class-details-step";
import StudentEnrollmentStep from "@/components/admin/class-wizard/student-enrollment-step";
import ConfirmationStep from "@/components/admin/class-wizard/confirmation-step";
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (result) {
        ...
        // router.push(`/dashboard/kelas/${result.classId}`);
      }
    } catch (error: any) {
